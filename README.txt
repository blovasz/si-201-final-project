...
3. Run the superhero.py file first to create and populate the main database: superhero.db.
4. Run the marvel_rivals.py file second to create and populate its tables to the superhero.db database.
5. Rune the superhero.py file third to create and populate its tables to the superhero.db database.
